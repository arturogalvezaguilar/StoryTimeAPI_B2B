...
import {
  GetVocabsUserResponse,
  VocabsUserResponse
} from "../responses/vocabs_user_response";
...
export class AppController {
  ...
  public async launchApplication(
    @Body() input: LaunchAppRequest
  ): Promise<LaunchAppResponse | ErrorResponse> {
    Logger.info(
      `Running launch application with input = ${JSON.stringify(input)}`
    );
    const response:
      | LaunchAppResponse
      | ErrorResponse = await this.launchAppService.launchApp(input);
  ...
  public async signLegal(
    @Body() input: LegalSignedRequest
  ): Promise<LegalSignedResponse | ErrorResponse> {
    console.log("Running LegalSigned with input = " + JSON.stringify(input));
    const response:
      | LegalSignedResponse
      | ErrorResponse = await this.appUserService.signLegal(input);
  ...
  public async loginAlternative(
    @Body() input: LoginAlternativeRequest
  ): Promise<LoginAlternativeResponse | ErrorResponse> {
    console.log(
      "Running LoginAlternative with input = " + JSON.stringify(input)
    );
    const response:
      | LoginAlternativeResponse
      | ErrorResponse = await this.loginAlternativeService.loginAlternative(
      input
    );
  ...
  public async loginRegular(
    @Body() input: LoginRegularRequest
  ): Promise<LoginRegularResponse | ErrorResponse> {
    console.log("Running LoginRegular with input = " + JSON.stringify(input));
    const response:
      | LoginRegularResponse
      | ErrorResponse = await this.loginRegularService.loginRegular(input);
  ...
  public async signup(
    ...
    const response:
      | SignUpResponse
      | ErrorResponse = await this.signUpService.signUp(input);
  ...
  public async validateEmail(
    @Body() input: ValidateEmailRequest
  ): Promise<ValidateEmailResponse | ErrorResponse> {
    console.log("Running ValidateEmail with input = " + JSON.stringify(input));
    const response:
      | ValidateEmailResponse
      | ErrorResponse = await this.emailService.validateEmail(input);
  ...
  ): Promise<SendEmailResponse | ErrorResponse> {
    console.log("Running reset password with input = " + JSON.stringify(input));
    const response:
      | SendEmailResponse
      | ErrorResponse = await this.emailService.resetPassword(input);
  ...
  public async validatePassword(
    @Body() input: ValidatePasswordRequest
  ): Promise<ValidatePasswordResponse | ErrorResponse> {
    console.log(
      "Running validate password with input = " + JSON.stringify(input)
    );
    const response:
      | ValidatePasswordResponse
      | ErrorResponse = await this.emailService.validatePassword(input);
  ...
  public async sendIAPReceipt(
    @Body() input: InAppReceiptRequest
  ): Promise<IAPReceiptResponse | ErrorResponse> {
    console.log(
      "Running Send IAP Receipt with input = " + JSON.stringify(input)
    );
    const response:
      | IAPReceiptResponse
      | ErrorResponse = await this.storeService.sendIAPReceipt(input);
  ...
  public async validateVoucher(
    @Body() input: ValidateVaucherRequest
  ): Promise<ValidateVoucherResponse | ErrorResponse> {
    console.log(
      "Running Validate Voucher with input = " + JSON.stringify(input)
    );
    const response:
      | ValidateVoucherResponse
      | ErrorResponse = await this.loginAlternativeService.validateVoucher(
      input
    );
  ...
  public async changeLanguage(
    @Body() input: ChangeLanguageRequest
  ): Promise<ChangeLanguageResponse | ErrorResponse> {
    console.log("Running ChangeLanguage with input = " + JSON.stringify(input));
    const response:
      | ChangeLanguageResponse
      | ErrorResponse = await this.changeLanguageService.changeLanguage(input);
  ...
  public async getAppUser(
    @Body() input: UserByIdRequest
  ): Promise<GetAppUserByIdResponse | ErrorResponse> {
    console.log("Running getAppUser with input = " + JSON.stringify(input));
    const response:
      | GetAppUserByIdResponse
      | ErrorResponse = await this.appUserService.getAppUser(input);
  ...
  public async saveOptin(
    @Body() input: SaveOptinRequest
  ): Promise<SaveOptinResponse | ErrorResponse> {
    console.log("Running SaveOptin with input = " + JSON.stringify(input));
    const response:
      | SaveOptinResponse
      | ErrorResponse = await this.appUserService.saveOptin(input);
  ...
  @ApiOkResponse({
    description: "Successful response",
    type: AppUserProgressionQuestionsByProduct
  })
  @ApiBadRequestResponse({
    description: "Bad request response",
    type: ErrorResponse
  ...
  public async getProgressionQuestions(
    @Body() input: GetQuestionsRequest
  ): Promise<AppUserProgressionQuestionsByProduct | ErrorResponse> {
    console.log(
      "Running questionsuserdata API with input = " + JSON.stringify(input)
    );
    const response:
      | AppUserProgressionQuestionsByProduct
      | ErrorResponse = await this.progressService.getProgressionQuestions(
      input
    );
    console.log(
      "Questions questionsuserdata API returns " + JSON.stringify(response)
    );
    return response;
  }
  ...
  @ApiOkResponse({
    description: "Successful response",
    type: SaveUserProgressionQuestionsResponse
  })
  @ApiBadRequestResponse({
    description: "Bad request response",
    type: ErrorResponse
  ...
  public async saveProgressionQuestions(
    @Body() input: SaveQuestionsRequest
  ): Promise<SaveUserProgressionQuestionsResponse | ErrorResponse> {
    console.log(
      "Running questionsuserdata API with input = " + JSON.stringify(input)
    );
    const response:
      | SaveUserProgressionQuestionsResponse
      | ErrorResponse = await this.progressService.saveProgressionQuestions(
      input
    );
    console.log(
      "Questions questionsuserdata API returns " + JSON.stringify(response)
  ...
  public async saveAppUserProgressionVideos(
    @Body() input: SaveVideosRequest
  ): Promise<VideosUserResponse | ErrorResponse> {
    console.log(
      "Running SaveAppUserProgressionVideos with input = " +
        JSON.stringify(input)
    );
    const response:
      | VideosUserResponse
      | ErrorResponse = await this.videosService.saveAppUserProgressionVideos(
      input
    );
    console.log(
      "SaveAppUserProgressionVideosAPI returns " + JSON.stringify(response)
    );
    return response;
  }
  ...
  public async saveAppUserProgressionVocabs(
    @Body() input: SaveVocabsRequest
  ): Promise<VocabsUserResponse | ErrorResponse> {
    console.log(
      "Running SaveAppUserProgressionVocabs with input = " +
        JSON.stringify(input)
    );
    const response:
      | VocabsUserResponse
      | ErrorResponse = await this.vocabsService.saveAppUserProgressionVocabs(
      input
    );
    console.log(
      "SaveAppUserProgressionVocabsAPI returns " + JSON.stringify(response)
    );
    return response;
  }
  ...
  @ApiOkResponse({
    description: "Successful response",
    type: AppUserProgressionVideosByProduct
  })
  @ApiBadRequestResponse({
    description: "Bad request response",
    type: ErrorResponse
  ...
  public async getVideosProgress(
    @Body() input: GetVideosRequest
  ): Promise<AppUserProgressionVideosByProduct | ErrorResponse> {
    console.log("Running GetVideos with input = " + JSON.stringify(input));
    const response:
      | AppUserProgressionVideosByProduct
      | ErrorResponse = await this.videosService.getAppUserProgressionVideos(
      input
    );
  ...
  @ApiOkResponse({
    description: "Successful response",
    type: AppUserProductProgression
  })
  @ApiBadRequestResponse({
    description: "Bad request response",
    type: ErrorResponse
  ...
  public async getAppUserProgressionVocabs(
    @Body() input: GetVocabsUserResponse
  ): Promise<AppUserProductProgression | ErrorResponse> {
    console.log(
      "Running getAppUserProgressionVocabs with input = " +
        JSON.stringify(input)
    );
    const response:
      | AppUserProductProgression
      | ErrorResponse = await this.vocabsService.getAppUserProgressionVocabs(
      input
    );
    console.log(
      "getAppUserProgressionVocabs API returns " + JSON.stringify(response)
    );
    return response;
  }
  ...
  public async sendWelcomeEmail(
    @Body() input: SendWelcomeEmailRequest
  ): Promise<SendEmailResponse | ErrorResponse> {
    console.log(
      "Running SendWelcomeEmail with input = " + JSON.stringify(input)
    );
    const response:
      | SendEmailResponse
      | ErrorResponse = await this.emailService.sendWelcomeEmail(input);
  ...
  public async updateUserType(
    @Body() input: UpdateUserTypeRequest
  ): Promise<UpdateUserTypeResponse | ErrorResponse> {
    console.log("Running UpdateUserType with input = " + JSON.stringify(input));
    const response:
      | UpdateUserTypeResponse
      | ErrorResponse = await this.appUserService.updateUserType(input);
  ...
  public async saveBigData(
    @Body() input: BigDataRequest
  ): Promise<BigDataResponse | ErrorResponse> {
    const response:
      | BigDataResponse
      | ErrorResponse = await this.bigDataService.saveData(input);
    return response;
  }
  ...
  public async contactUS(
    @Body() input: ContactUsRequest
  ): Promise<SESEmailSenderResponse | ErrorResponse> {
    console.log("Running contact us API with input = " + JSON.stringify(input));
    const response:
      | SESEmailSenderResponse
      | ErrorResponse = await this.emailService.sendContactUsEmail(input);
  ...
  public async contactUSWeb(
    @Body() input: ContactUsWebRequest
  ): Promise<SESEmailSenderResponse | ErrorResponse> {
    console.log(
      "Running contact us WEB API with input = " + JSON.stringify(input)
    );
    const response:
      | SESEmailSenderResponse
      | ErrorResponse = await this.webService.sendContactUsEmail(input);
