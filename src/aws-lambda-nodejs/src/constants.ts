...
export const VOCABS_GET_USER_PROGRESSION_DATA_PATH =
  "appuser/getvocabsuserdata";
...
export const COLLECTION_PROGRESS_PATH =
  "appuser/:id/page_progress/collections/:collectionId";
...
export const CONTACT_US_RECIPIENT_EMAIL =
  process.env.CONTACT_US_RECIPIENT_EMAIL;
