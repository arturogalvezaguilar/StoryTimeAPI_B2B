...
export class PageProgressService {
  ...
  public async getGameProgress(userId: string, gameId: string): Promise<Game> {
    if (!userId || !gameId)
      throw new BadRequestException("userId and gameId are strict params");
  ...
  public async putGameProgress(
    ...
    if (!inputValidator.isValid)
      throw new BadRequestException(inputValidator.message);
  ...
  public async getVideoProgress(
    ...
    if (!userId || !videoId)
      throw new BadRequestException("userId and videoId are strict params");
  ...
  public async putVideoProgress(
    ...
    const inputValidator = validateInput(
      ["stepsProgress", "movieProgress", "movieStarCount", "movieUTCTime"],
      video
    );
    if (!inputValidator.isValid)
      throw new BadRequestException(inputValidator.message);
  ...
  public async getCollectionProgress(
    ...
    if (!userId || !collectionId)
      throw new BadRequestException(
        "userId and collectionId are strict params"
      );
