...
export class VideosService {
  ...
  public async saveAppUserProgressionVideos(
    ...
    const userProgression: AppUserProgressionVideosByProduct = await this.AppUserProgressionVideosByProductDAO.getItemByGSI(
  ...
  public async getAppUserProgressionVideos(
    input: any
  ...
  private async updateUsersProgression(appUser, input): Promise<void> {
    ...
    try {
      await this.AppUserProgressionVideosByProductDAO.putItemToDB(
        constants.APP_USER_PROGRESSION_VIDEOS_BY_PRODUCT_TABLE,
        appUser
      );
      ...
      await this.progressService.updateVideosProgress(
        appUser,
        input.videosProgress
      );
      await this.progressService.updateVideosFranchiseProgress(
        appUser,
        input.franchiseUserDataList
      );
    } catch (error) {
